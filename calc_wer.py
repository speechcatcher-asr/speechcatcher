...
def calculate_word_error_rate(kaldi_test_text_file, decoded_text_file, remove_punctuation=False, split_camel_case=True):
    tokenizer = SoMaJo(language="de_CMC", split_camel_case=split_camel_case)
    ...
    decoded_utterances_ids = decoded_utterances.keys()
...
if __name__ == "__main__":
    ...
    calculate_word_error_rate(args.testset_text, args.decoded_text, remove_punctuation=args.remove_punctuation)
